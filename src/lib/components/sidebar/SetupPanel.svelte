		...
		<Card.Content>
			...
			<div class="flex flex-col justify-center items-center w-full mt-2">
				<div class="pb-8 text-center">
					<p class="mt-3 font-bold text-xl">It looks like something went wrong.</p>
					<p class="">
						We weren't able to fetch your activities from Strava. 
						You should try signing out and authenticating with Strava again.
						If that doesn't work, we might be recieving too many
