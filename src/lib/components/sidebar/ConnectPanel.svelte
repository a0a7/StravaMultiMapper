		...
		<Alert.Root>
			...
			<Alert.Description>
				<p>
					...
					highest privacy standard possible--if you want to know more, read our privacy policy.
				</p>
				<p>
					...
					>
					under the
					<a href="https://github.com/sudolev/StravaMultiMapper/blob/main/LICENSE" target="_blank"
						>GPL-3.0 license</a
					>.
				</p>
			</Alert.Description>
